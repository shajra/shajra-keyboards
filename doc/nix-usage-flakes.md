...
```
    ...
    /nix/store/crlf3ggajy1sdcbzjjm15njvkhr8p07d-shajra-keyboards-licenses-env
...
```
    ...
    /nix/store/crlf3ggajy1sdcbzjjm15njvkhr8p07d-shajra-keyboards-licenses-env/bin/shajra-keyboards-licenses
...
```
    ...
    Store paths:        /nix/store/crlf3ggajy1sdcbzjjm15njvkhr8p07d-shajra-keyboards-licenses-env
