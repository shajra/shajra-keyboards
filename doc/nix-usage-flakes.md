...
```
    ...
    /nix/store/ri9fgiyxd4faj2l9z8m55varw730wg0i-shajra-keyboards-licenses-env
...
```
    ...
    /nix/store/ri9fgiyxd4faj2l9z8m55varw730wg0i-shajra-keyboards-licenses-env/bin/shajra-keyboards-licenses
...
```
    ...
    Store paths:        /nix/store/ri9fgiyxd4faj2l9z8m55varw730wg0i-shajra-keyboards-licenses-env
