...
```
    ...
    /nix/store/11mlrdrfq6cvp66zdipmyh6m1d3snvnb-shajra-keyboards-licenses-env
...
```
    ...
    /nix/store/11mlrdrfq6cvp66zdipmyh6m1d3snvnb-shajra-keyboards-licenses-env/bin/shajra-keyboards-licenses
...
```
    ...
    Store paths:        /nix/store/11mlrdrfq6cvp66zdipmyh6m1d3snvnb-shajra-keyboards-licenses-env
