...
```
    ...
    /nix/store/fzym3acq6sndvl7gjywn0v7xny0s1vkv-shajra-keyboards-licenses
...
```
    ...
    /nix/store/fzym3acq6sndvl7gjywn0v7xny0s1vkv-shajra-keyboards-licenses/bin/shajra-keyboards-licenses
...
```
    ...
    Store paths:        /nix/store/fzym3acq6sndvl7gjywn0v7xny0s1vkv-shajra-keyboards-licenses
