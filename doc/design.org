...
Lastly, I own all four keyboards supported by this project.  I occaisionally
swap keyboards, and don't want to think too hard about the transition.  That's
led to a numpad layout that doesn't take advantage of the lowest row of the
Moonlander or Ergodox EZ keyboards.  However, I don't believe I've compromised
any ergonomic benefits for the convenience of swapping keyboards easily.
