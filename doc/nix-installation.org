...
This project pushes built Nix packages to the [[cachix][Cachix]] substituter as part
of its continuous integration. It's recommended to configure Nix to use this
cache.
