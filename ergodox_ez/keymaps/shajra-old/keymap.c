...
{ [BASE] = LAYOUT_ergodox
    ...
    , _______,           KC_Q,          KC_W,          KC_E,            KC_R,                  KC_T, KC_PGUP
    , LT(MEDIA, KC_TAB), KC_A,          KC_S,          KC_D,            KC_F,                  KC_G
    , LSFT_T(KC_LBRC),   KC_Z,          KC_X,          KC_C,            KC_V,                  KC_B, KC_PGDN
    , _______,           OSM(MOD_RALT), LSFT(KC_RALT), LCTL_T(KC_LEFT), LT(FUNCTION, KC_RIGHT)
    ,                                                                           LT(NUMPAD, KC_DEL), KC_HOME
    ,                                                                                               KC_APP
    ,                                                               LGUI_T(KC_ENT), LSFT_T(KC_TAB), LALT_T(KC_ESC)
    // right hand
    ...
    ,                LT(FUNCTION, KC_DOWN), RCTL_T(KC_UP), RSFT(KC_RALT), OSM(MOD_RALT), _______
    , KC_END, KC_INS
    , KC_APP
    , RGUI_T(KC_GRV), RSFT_T(KC_BSPC), LALT_T(KC_SPC)
    )
, [MAC] = LAYOUT_ergodox
    // left hand
    ...
    ,                                              _______, _______
    ,                                                       _______
    ,                              LALT_T(KC_ENT), _______, LGUI_T(KC_ESC)
    // right hand
    , _______, _______, _______, _______, _______, _______, _______
    , _______, _______, _______, _______, _______, _______, _______
    ,          _______, _______, _______, _______, _______, _______
    ...
    , _______, _______
    , _______
    , LALT_T(KC_GRV), _______, RGUI_T(KC_SPC)
    )
, [FUNCTION] = LAYOUT_ergodox
    // left hand
    ( _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   VRSN
    , _______, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, _______, _______
    , _______, KC_CIRC, KC_DLR,  KC_LPRN, KC_RPRN, _______
    , _______, KC_HASH, KC_PERC, KC_LBRC, KC_RBRC, _______, _______
    ...
    , _______, KC_F11,  KC_AMPR, KC_ASTR, KC_PIPE, KC_BSLS, _______
    ,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_GRV,  _______
    , _______, KC_F12,  KC_TILD, KC_SLSH, KC_HOME, KC_END,  _______
    ,                   _______, _______, _______, _______, _______
    , _______, _______
    , _______
    , _______, _______, _______
