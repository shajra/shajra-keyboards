...
{ [BASE] = LAYOUT_moonlander
    ( KC_CAPS,           KC_1, KC_2, KC_3, KC_4, KC_5, RM_NEXT, /**/ RM_PREV, KC_6, KC_7, KC_8,    KC_9,   KC_0,    TG(NUMPAD)
...
, [FUNCTION] = LAYOUT_moonlander
    ( RM_VALU, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   RM_TOGG, /**/ TG(MAC), KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______
    , RM_VALD, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_QUOT, KC_HOME, /**/ KC_PLUS, KC_TILD, KC_AMPR, KC_ASTR, KC_SLSH, KC_BSLS, KC_F11
    , RM_HUEU, KC_CIRC, KC_DLR,  KC_LPRN, KC_RPRN, KC_DQUO, KC_END,  /**/ KC_UNDS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_COLN, KC_F12
    , RM_HUED, KC_HASH, KC_PERC, KC_LBRC, KC_RBRC, KC_GRV,           /**/          _______, KC_PIPE, KC_LT,   KC_GT,   KC_QUES, RM_SATU
    , RM_SPDU, RM_SPDD, _______, KC_LEFT, KC_RGHT,    OSM(MOD_LGUI), /**/ KC_GRV,           KC_DOWN, KC_UP,   _______, _______, RM_SATD
...
, [MOUSE] = LAYOUT_moonlander
    ( _______, _______, _______, _______, _______, _______, _______, /**/ _______, _______, _______, _______, _______, _______, _______
    , _______, _______, _______, MS_UP,   _______, _______, _______, /**/ _______, _______, _______, MS_WHLU, _______, _______, _______
    , _______, _______, MS_LEFT, MS_DOWN, MS_RGHT, _______, _______, /**/ _______, _______, MS_WHLL, MS_WHLD, MS_WHLR, _______, _______
    , _______, _______, _______, _______, _______, _______,          /**/          _______, _______, _______, _______, _______, _______
    , _______, _______, _______, _______, _______,          _______, /**/ _______,          _______, _______, _______, _______, _______
    ,                                     MS_BTN1, MS_BTN2, MS_BTN3, /**/ _______, MS_BTN4, MS_BTN5
    )
};
