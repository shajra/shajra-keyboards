# Ergonomic Keyboard "shajra" Mappings
...
Below, you'll learn how you can use this keymap.  But to get the most out of the
keymap, you may be interested in the [design document](doc/design.md) explaining
...
* [Using these key mappings](#using-these-key-mappings)
   ...
   * [5. Get the code and run it](#5-get-the-code-and-run-it)
      ...
      * [Flashing a Keybaordio Model 01 keyboard](#flashing-a-keybaordio-model-01-keyboard)
...
#### Flashing a Keybaordio Model 01 keyboard
...
been mapped to on your Keyboard, you can hit `Enter` on another keyboard.
...
For both keybaords, The "shajra" keymap is in it's own directory.  You can make
