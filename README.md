...
1.  Flashing an Ergodox EZ keyboard
    ...
    ```
        ...
        FLASH SOURCE: /nix/store/xb03hlz0w25dfc3w9j9w91p7r0w5c5gs-qmk-custom-shajra-src
        FLASH BINARY: /nix/store/v7kwjbi0pdnfpm0gmllrmh0dnglbqdn2-ergodoxez-custom-shajra.hex
        
        Teensy Loader, Command Line, Version 2.1
        Read "/nix/store/v7kwjbi0pdnfpm0gmllrmh0dnglbqdn2-ergodoxez-custom-shajra.hex": 22594 bytes, 70.0% usage
...
2.  Flashing a Moonlander keyboard
    ...
    ```
        ...
        FLASH SOURCE: /nix/store/93ckj8dh920a67jr7x7fs3y40vsvdgfa-qmk-custom-shajra-src
        FLASH BINARY: /nix/store/fkmjsnryikafgnsgmmzjabrvas8avp4v-moonlander-custom-shajra.bin
...
3.  Flashing a Keyboardio Model 01 keyboard
    ...
    ```
        ...
        FLASH BINARY: /nix/store/bqwmk626i20j2w9681n2czbp1cv6swnz-model01-custom-shajra-hex
