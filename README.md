...
```
    ...
    /nix/store/fxnldk4pljj6y8a899hpfazasdf51256-shajra-keyboards-ci
    ...
    ├── build-model01-builtin-shajra-flash -> /nix/store/mka6177pwirfbnw41r5fvpxn53ladq97-model01-builtin-shajra-flash
    ├── build-model01-builtin-shajra-hex -> /nix/store/wgy2rg9cr9zr1r5vshsbw462bdm96ps8-model01-builtin-shajra-hex
    ├── build-model01-factory-flash -> /nix/store/n2b3c6i1llq968lapajg2614508rmp0s-model01-factory-flash
    ├── build-model01-factory-hex -> /nix/store/w1zphfpkb09jrijxdppw1f38fvp4ypk1-model01-factory-hex
    ├── build-model100-builtin-shajra-flash -> /nix/store/p5zaz7mk83lsn9yyyy3rwq4wjyjghbmh-model100-builtin-shajra-flash
    ├── build-model100-builtin-shajra-hex -> /nix/store/admxy34rly5hnvswzlfn1gchc76hjqzp-model100-builtin-shajra-hex
    ├── build-model100-factory-flash -> /nix/store/g3pdl1yiy4qmza55kbccdsqfcpdsc35s-model100-factory-flash
    ├── build-model100-factory-hex -> /nix/store/q7aw2sb6nxq4sfbvm254kmpyjyczai4d-model100-factory-hex
    ...
    ├── flash-ergodoxez -> /nix/store/7fafz6grzpykq8cr24mbfiy80vhas4cp-flash-ergodoxez
    ├── flash-model01 -> /nix/store/idgdh21zkabv1l4wvskk95jscimczflz-flash-model01
    ├── flash-model100 -> /nix/store/fx2yhwgk3ipnjk9w2hvx15w6z4m1p7n4-flash-model100
    ├── flash-moonlander -> /nix/store/52qwin8wwh8c43d1snwvpd21i6jk0hkr-flash-moonlander
