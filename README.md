...
```
    ...
    /nix/store/91n7z91fsrjbsgm52jchh8vr2wwz7h5v-shajra-keyboards-ci
    ...
    ├── flash-ergodoxez -> /nix/store/9bx5rqycbr4v7ahl2p1inh9xs3a88vw7-flash-ergodoxez
    ├── flash-model01 -> /nix/store/jabrn59mdcfy5gy3ikaabj744ads5dp1-flash-model01
    ├── flash-model100 -> /nix/store/02d1fpbfiv9qlvysk1ls0z1m4zkzxs0m-flash-model100
    ├── flash-moonlander -> /nix/store/y7b3gkm4a07lc2glj65b2zx2a806yigh-flash-moonlander
