...
```
    ...
    /nix/store/4406sdxfbzpq09nfx4b4qp1sqxlr9kig-shajra-keyboards-ci
    ...
    ├── build-model01-builtin-shajra-flash -> /nix/store/3va31i9p9ngmw8wmxsxpz85zc0n1y06m-model01-builtin-shajra-flash
    ├── build-model01-builtin-shajra-hex -> /nix/store/wg251ky4civ1idr711m240wk8c4sd7bh-model01-builtin-shajra-hex
    ...
    ├── build-model100-builtin-shajra-flash -> /nix/store/srcsgzbdc02nwg2mhzs39n64jhd8qiki-model100-builtin-shajra-flash
    ├── build-model100-builtin-shajra-hex -> /nix/store/jk6118f7z90nh5q9nglgxkkahwjgn06l-model100-builtin-shajra-hex
    ...
    ├── flash-ergodoxez -> /nix/store/960zi01k3mqjf9abap4cj10yhxvnz54k-flash-ergodoxez
    ├── flash-model01 -> /nix/store/f7pk7c2kiw4mkk7g1gbiglxya7iv941b-flash-model01
    ├── flash-model100 -> /nix/store/45v375f98brxv6fn2m6zxp2fqbcckc6b-flash-model100
    ├── flash-moonlander -> /nix/store/nq5wlzk4dk5gmsci3kiyn0lbr0mraxjz-flash-moonlander
