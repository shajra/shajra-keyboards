...
```
    ...
    /nix/store/7rzc0ykdrh7yz25ir90wily7xvq1nbbq-shajra-keyboards-ci
    ...
    ├── build-model01-builtin-shajra-flash -> /nix/store/zdmli1bq0xr5rci25x9zrz5h85aswa04-model01-builtin-shajra-flash
    ├── build-model01-builtin-shajra-hex -> /nix/store/abdamprpi4x70hm6y430nj8hip6h1jxc-model01-builtin-shajra-hex
    ├── build-model01-factory-flash -> /nix/store/1cngqw5i8727yzwwb3wl7f7yjjqmi2gq-model01-factory-flash
    ├── build-model01-factory-hex -> /nix/store/sa7czchj37294mfimzlg6skg233pa75w-model01-factory-hex
    ├── build-model100-builtin-shajra-flash -> /nix/store/r0y8sypm3dy23mjfbyla11dldwicn1rc-model100-builtin-shajra-flash
    ├── build-model100-builtin-shajra-hex -> /nix/store/gad0g1kdpg8k1sjgcqcarymgv780p7yp-model100-builtin-shajra-hex
    ├── build-model100-factory-flash -> /nix/store/v8fjdvzh8z88ym4c04ikjdq7133nl5p3-model100-factory-flash
    ├── build-model100-factory-hex -> /nix/store/b9ljgmdzllrw0bkim0r5wkams2b0vibf-model100-factory-hex
    ...
    ├── flash-ergodoxez -> /nix/store/5ksjxsr5kapd96856gljqd9gxbslp6mh-flash-ergodoxez
    ├── flash-model01 -> /nix/store/xxvvgqc1jh30kfsf3m6f3i4dkibhrbrc-flash-model01
    ├── flash-model100 -> /nix/store/s015pyn09iw88ppvk8afzx1mfzf42v1i-flash-model100
    ├── flash-moonlander -> /nix/store/xrgw295f8jabbjgxvzgswnxi77i3wqll-flash-moonlander
