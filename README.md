...
```
    ...
    FLASH SOURCE: /nix/store/ijyn28knkd04k8f9g7r47c3f8scycnb8-qmk-builtin-shajra-src
    FLASH BINARY: /nix/store/97p4bskic61xahi8qy1c8ikqcl5wn9ky-ergodoxez-builtin-shajra.hex
...
```
    ...
    /nix/store/mbrgrd24zhk3capaqryjbvn4hczagb0q-shajra-keyboards-ci
    ├── build-ergodoxez-builtin-shajra-flash -> /nix/store/f6jma7i4wwvkd6ncg85b7zngcv5d8lbs-ergodoxez-builtin-shajra-flash
    ├── build-ergodoxez-builtin-shajra-hex -> /nix/store/97p4bskic61xahi8qy1c8ikqcl5wn9ky-ergodoxez-builtin-shajra.hex
    ...
    ├── build-moonlander-builtin-shajra-flash -> /nix/store/a5hh70bkdqp68vbxix6146n0zz54ir3i-moonlander-builtin-shajra-flash
    ├── build-moonlander-builtin-shajra-hex -> /nix/store/1pp7x9z2vhwhrwf7nh3lr8w1ncbd4c52-moonlander-builtin-shajra.bin
    ...
    ├── flash-ergodoxez -> /nix/store/8s0cpjxmqk62xn0mfhqi4m0xin3qbbam-flash-ergodoxez
    ├── flash-model01 -> /nix/store/8gdayfi4rr2y0wh3jqrq3g6j48qzj1z1-flash-model01
    ├── flash-model100 -> /nix/store/fn5p9vlkdzbnz6452q0ncb5bz9amv8b9-flash-model100
    ├── flash-moonlander -> /nix/store/1ihic51q1h4nipw2d0wqdjbm0hcrv9bv-flash-moonlander
